...
public class UserBOImpl implements UserBO {
    ...
    public ArrayList<UserDTO> getAllUser() throws SQLException, ClassNotFoundException {
        ...
        for (User u : all) {
            allUser.add(new UserDTO(u.getUser_id(),u.getUser_name(),u.getPassword(),u.getRanks(),u.getEmail(),u.getNic(),u.getContactno()));
        }
        return allUser;
    }
    ...
    public boolean addUser(UserDTO dto) throws SQLException, ClassNotFoundException {
        return userDAO.add(new User(dto.getUser_id(),dto.getUser_name(),dto.getPassword(),dto.getRanks(),dto.getEmail(),dto.getNic(),dto.getContactno()));
    }

    @Override
    public boolean updateUser(UserDTO dto) throws SQLException, ClassNotFoundException {
        return userDAO.update(new User(dto.getUser_id(),dto.getUser_name(),dto.getPassword(),dto.getRanks(),dto.getEmail(),dto.getNic(),dto.getContactno()));
    }
    ...
    public UserDTO searchUser(String id) throws SQLException, ClassNotFoundException {
        ...
        return new UserDTO(user.getUser_id(),user.getUser_name(),user.getPassword(),user.getRanks(),user.getEmail(),user.getNic(),user.getContactno());
    }
}
